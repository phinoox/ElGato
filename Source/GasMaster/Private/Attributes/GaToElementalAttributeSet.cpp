...
#include "Attributes/GaToElementalAttributeSet.h"

#include "GameplayEffectExtension.h"

bool UGaToElementalAttributeSet::PreGameplayEffectExecute(struct FGameplayEffectModCallbackData& Data)
{
	return Super::PreGameplayEffectExecute(Data);
}

void UGaToElementalAttributeSet::PostGameplayEffectExecute(const struct FGameplayEffectModCallbackData& Data)
{
...
void UGaToElementalAttributeSet::PostAttributeChange(const FGameplayAttribute& Attribute, float OldValue,
                                                     float NewValue)
{
...
void UGaToElementalAttributeSet::PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue)
{
