...
#include "GaToBaseAttributeSet.generated.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FPGaToAttributeEvent, float, EffectMagnitude, float, NewValue);
 ...
 */
UCLASS()
class GASMASTER_API UGaToBaseAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
